from test_pkg.social_gym.src.utils import bound_angle, PRECISION
from test_pkg.social_gym.src.human_agent import HumanAgent
from test_pkg.social_gym.src.robot_agent import RobotAgent
from test_pkg.social_gym.src.agent import Agent
from test_pkg.social_gym.src.social_momentum import *
from test_pkg.social_gym.src.forces_parallel import update_humans_parallel
...
class MotionModelManager:
    ...
    def set_human_motion_model(self, motion_model_title:str):
        ...
        if self.motion_model_title == "sfm_helbing": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_helbing as compute_obstacle_force, compute_social_force_helbing as compute_social_force, compute_all_social_forces, compute_group_force_dummy as compute_group_force; self.headed = False; self.include_mass = True; self.type = 0
        elif self.motion_model_title == "sfm_guo": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_guo as compute_obstacle_force, compute_social_force_guo as compute_social_force, compute_all_social_forces, compute_group_force_dummy as compute_group_force; self.headed = False; self.include_mass = True; self.type = 1
        elif self.motion_model_title == "sfm_moussaid": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_helbing as compute_obstacle_force, compute_social_force_moussaid as compute_social_force, compute_all_social_forces, compute_group_force_dummy as compute_group_force; self.headed = False; self.include_mass = True; self.type = 2
        elif self.motion_model_title == "sfm_roboticsupo": from test_pkg.social_gym.src.forces import compute_desired_force_roboticsupo as compute_desired_force, compute_obstacle_force_roboticsupo as compute_obstacle_force, compute_social_force_roboticsupo as compute_social_force, compute_all_social_forces, compute_group_force_roboticsupo as compute_group_force; self.headed = False; self.include_mass = False; self.type = 3
        elif self.motion_model_title == "hsfm_farina": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_helbing as compute_obstacle_force, compute_social_force_helbing as compute_social_force, compute_all_social_forces, compute_torque_force_farina as compute_torque_force, compute_group_force_dummy as compute_group_force; self.headed = True; self.include_mass = True; self.type = 0
        elif self.motion_model_title == "hsfm_guo": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_guo as compute_obstacle_force, compute_social_force_guo as compute_social_force, compute_all_social_forces, compute_torque_force_farina as compute_torque_force, compute_group_force_dummy as compute_group_force; self.headed = True; self.include_mass = True; self.type = 1
        elif self.motion_model_title == "hsfm_moussaid": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_helbing as compute_obstacle_force, compute_social_force_moussaid as compute_social_force, compute_all_social_forces, compute_torque_force_farina as compute_torque_force, compute_group_force_dummy as compute_group_force; self.headed = True; self.include_mass = True; self.type = 2
        elif self.motion_model_title == "hsfm_new": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_helbing as compute_obstacle_force, compute_social_force_helbing as compute_social_force, compute_all_social_forces, compute_torque_force_new as compute_torque_force, compute_group_force_dummy as compute_group_force; self.headed = True; self.include_mass = True; self.type = 0
        elif self.motion_model_title == "hsfm_new_guo": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_guo as compute_obstacle_force, compute_social_force_guo as compute_social_force, compute_all_social_forces, compute_torque_force_new as compute_torque_force, compute_group_force_dummy as compute_group_force; self.headed = True; self.include_mass = True; self.type = 1
        elif self.motion_model_title == "hsfm_new_moussaid": from test_pkg.social_gym.src.forces import compute_desired_force, compute_obstacle_force_helbing as compute_obstacle_force, compute_social_force_moussaid as compute_social_force, compute_all_social_forces, compute_torque_force_new as compute_torque_force, compute_group_force_dummy as compute_group_force; self.headed = True; self.include_mass = True; self.type = 2
        elif self.motion_model_title == "orca": 
    ...
    def set_robot_motion_model(self, motion_model_title:str, runge_kutta:bool):
        ...
        if self.robot_motion_model_title == "sfm_helbing": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_helbing as compute_robot_obstacle_force, compute_social_force_helbing as compute_robot_social_force; self.robot.headed=False; self.robot_headed = False; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "sfm_guo": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_guo as compute_robot_obstacle_force, compute_social_force_guo as compute_robot_social_force; self.robot.headed=False; self.robot_headed = False; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "sfm_moussaid": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_helbing as compute_robot_obstacle_force, compute_social_force_moussaid as compute_robot_social_force; self.robot.headed=False; self.robot_headed = False; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "sfm_roboticsupo": from test_pkg.social_gym.src.forces import compute_desired_force_roboticsupo as compute_robot_desired_force, compute_obstacle_force_roboticsupo as compute_robot_obstacle_force, compute_social_force_roboticsupo as compute_robot_social_force; self.robot.headed=False; self.robot_headed = False; self.robot_include_mass = False; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "hsfm_farina": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_helbing as compute_robot_obstacle_force, compute_social_force_helbing as compute_robot_social_force, compute_torque_force_farina as compute_robot_torque_force; self.robot.headed=True; self.robot_headed = True; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "hsfm_guo": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_guo as compute_robot_obstacle_force, compute_social_force_guo as compute_robot_social_force, compute_torque_force_farina as compute_robot_torque_force; self.robot.headed=True; self.robot_headed = True; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "hsfm_moussaid": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_helbing as compute_robot_obstacle_force, compute_social_force_moussaid as compute_robot_social_force, compute_torque_force_farina as compute_robot_torque_force; self.robot.headed=True; self.robot_headed = True; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "hsfm_new": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_helbing as compute_robot_obstacle_force, compute_social_force_helbing as compute_robot_social_force, compute_torque_force_new as compute_robot_torque_force; self.robot.headed=True; self.robot_headed = True; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "hsfm_new_guo": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_guo as compute_robot_obstacle_force, compute_social_force_guo as compute_robot_social_force, compute_torque_force_new as compute_robot_torque_force; self.robot.headed=True; self.robot_headed = True; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "hsfm_new_moussaid": from test_pkg.social_gym.src.forces import compute_desired_force as compute_robot_desired_force, compute_obstacle_force_helbing as compute_robot_obstacle_force, compute_social_force_moussaid as compute_robot_social_force, compute_torque_force_new as compute_robot_torque_force; self.robot.headed=True; self.robot_headed = True; self.robot_include_mass = True; self.robot_orca = False; self.robot.orca = False
        elif self.robot_motion_model_title == "orca": 
